...
_R2_FINISHED_FOLLOWUP = (
    "Отлично, ты молодец!\n\n"
    "Это была последняя тема тура, спасибо за твои ответы! Мы объявим результаты в письме, "
    "которое пришлём 25.05 на указанную почту, а пока принимай участие в финальном туре, "
    "который стартует 20.05"
)
